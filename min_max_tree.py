...
def calcMaxNumTurns(
    ...
    minimizerMaxNumTurns: int = ceil(float(
        minimizer_health)/min_dmg_health) + ceil(float(minimizer_shields)/min_dmg_shields)
    maximizerMaxNumTurns: int = ceil(float(
        maximizer_health)/min_dmg_health) + ceil(float(maximizer_shields)/min_dmg_shields)
